...
class ConsumableExport implements FromCollection, WithHeadings, Responsable, WithStyles, WithDrawings
{
    use Exportable;
    ...
    public function __construct(Collection $consumables, $personName, $document_number, $planning_date)
    {
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        foreach ($this->consumables as $consumable) {
            ...
            $sheet->setCellValue('E' . $currentRow, $consumable->inventory->element->name);
            ...
            $sheet->setCellValue('I' . $currentRow, $consumable->amount / $consumable->inventory->element->measurement_unit->conversion_factor);
