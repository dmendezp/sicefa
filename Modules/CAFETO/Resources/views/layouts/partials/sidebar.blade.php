    ...
    <div class="sidebar">
            ...
            @guest
                <div class="col info info-user">
                    <a href="{{ route('login') }}" class="d-block custom-color"
                        style="text-decoration: none">{{ trans('cafeto::general.Log In') }}</a>
                </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('cafeto.inventory.index') }}"
                        class="nav-link {{ !Route::is('cafeto.inventory.index*') ?: 'active' }} text-light">
                ...
                <li class="nav-item">
                    <a href="{{ route('cafeto.sale.index') }}"
                        class="nav-link {{ !Route::is('cafeto.sale.index*') ?: 'active' }} text-light">
                ...
                <li class="nav-item">
                    <a href="{{ route('cafeto.element.index') }}"
                        class="nav-link {{ !Route::is('cafeto.element.index*') ?: 'active' }} text-light">
