                ...
                <div class="card-body">
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col-lg-3 mb-4" data-aos="zoom-in">
                                <img class="bd-placeholder-img rounded-circle" src="{{ asset('modules/cafeto/images/developers/Nelsy-Profile.jpg') }}" alt="NelsyProfile" width="140" height="140">
                                <h4>{{ trans('cafeto::devs.Description_Apprentice') }}</h4>
                            ...
                            <div class="col-lg-3 mb-4" data-aos="zoom-in">
                                <img class="bd-placeholder-img rounded-circle" src="{{ asset('modules/cafeto/images/developers/ANYI-Profile.jpg') }}" alt="AnyiProfile" width="140" height="140">
                                <h4>{{ trans('cafeto::devs.Description_Apprentice') }}</h4>
