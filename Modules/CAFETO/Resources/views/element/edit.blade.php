...
@push('breadcrumbs')
    <li class="breadcrumb-item active">
        <a href="{{ route('cafeto.' . getRoleRouteName(Route::currentRouteName()) . '.element.index') }}" 
        class="text-decoration-none">{{ trans('cafeto::element.Breadcrumb_Element') }}</a>
    </li>
    <li class="breadcrumb-item active">{{ trans('cafeto::element.Breadcrumb_Active_Edit_Element') }}</li>
@endpush

@section('content')
    <form action="{{ route('cafeto.' . getRoleRouteName(Route::currentRouteName()) . '.element.update', $element) }}"
        ...
        <div class="card card-success card-outline mx-auto">
            ...
            <div class="card-footer bg-white text-right">
                ...
                @if (Auth::user()->havePermission('cafeto.' . getRoleRouteName(Route::currentRouteName()) . '.element.update'))
