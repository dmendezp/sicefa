<div>
                    ...
                    <div class="table-responsive" style="max-height: 500px">
                        <table class="table">
                            <thead class="table-dark">
                                <tr>
                                    <th class="text-center">{{ trans('cafeto::sales.2T_Number') }}</th>
                                    <th>{{ trans('cafeto::sales.2T_Product') }}</th>
                                    <th class="text-center">{{ trans('cafeto::sales.2T_Amount') }}</th>
                                    <th class="text-center">{{ trans('cafeto::sales.2T_Value') }}</th>
                                    <th class="text-center">{{ trans('cafeto::sales.2T_Total') }}</th>
                                    <th class="text-center">{{ trans('cafeto::sales.2T_Actions') }}</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div class="col-md-3">
            <div class="card card-success">
                <div class="card-header text-center custom-card-header">
                    <strong>{{ trans('cafeto::sales.Title_Sales_Data') }}</strong>
                </div>
                <div class="card-body py-1 pb-2">

                    <label class="form-label my-0 mt-1">{{ trans('cafeto::sales.Text_Identification') }}</label>
                    <div class="row">
                    ...
                    <label class="form-label my-0">{{ trans('cafeto::sales.Text_Name') }}</label>
                    ...
                    <div class="text-center mt-2">
                        @if (Auth::user()->havePermission('cafeto.admin-cashier.generate.sale'))
                            <button class="btn btn-sm btn-success" id="sale_button"
                                ...
                                {{ trans('cafeto::sales.Btn_Register_Sale') }}
                            </button>
                        @endif
                    </div>
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header py-2">
                    <h1 class="modal-title fs-5" id="registerCustomerLabel">{{ trans('cafeto::sales.Title_Modal') }}
                    </h1>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="registerCustomer">
                        <div class="alert alert-danger py-1" role="alert">
                            <strong style="font-size: 12px">{{ trans('cafeto::sales.Alert_Modal') }}</strong>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit"
                            class="btn btn-sm btn-success py-0 float-end">{{ trans('cafeto::sales.Btn_Register_Client') }}</button>
                        <button type="button" class="btn btn-sm btn-secondary py-0 me-1 float-end"
                            data-bs-dismiss="modal"
                            wire:click="resetFormRegisterCustomer">{{ trans('cafeto::sales.Btn_Cancel_Register') }}</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    @section('sripts-generate-sale')
        ...
        <script src="{{ asset('modules/cafeto/js/sale/register/livewire-register-sale.js') }}"></script>
        ...
        <script>
            window.translations = @json([
                'alertChangeOf' => __('cafeto::sales.Alert_Change_Of'),
                'btnAccept' => __('cafeto::sales.Btn_Accept'),
            ]);
        </script>
    @endsection
</div>
