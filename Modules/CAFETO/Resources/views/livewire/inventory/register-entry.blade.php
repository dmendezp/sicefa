                ...
                <div class="row mx-3 align-items-end">
                    <div class="col-md-7">
                        <div class="form-group">
                            <label><strong class="text-danger">*</strong>{{ trans('cafeto::inventory.Title_Form_Product') }}</label>
                            <div class="input-group">
                                ...
                                <select class="form-select" name="product_element_id" id="product_element_id"
                                    ...
                                    <option value="" data-price="">{{ trans('cafeto::inventory.Select_Form_Product') }}</option>
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label><strong class="text-danger">*</strong>{{ trans('cafeto::inventory.Title_Form_Amount') }}</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                    ...
                    <div class="col-6">
                        ...
                        {{-- NUEVO: checkbox POPULAR --}}
                        <div class="col-12 mt-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="product_is_popular" wire:model.defer="product_is_popular">
                                <label class="form-check-label" for="product_is_popular">
                                    Marcar como <strong>Popular</strong> (aparece en el inicio)
                                </label>
                            </div>
                        </div>

                        <div class="col-auto mx-auto mt-2">
                            <button type="submit" class="btn btn-success form-control text-truncate">
                                {{ trans('cafeto::inventory.Btn_Add_Product') }} <i class="fas fa-plus"></i>
                            </button>
                        </div>
                    ...
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="text-center" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="{{ trans('cafeto::inventory.2T_Actions') }}">
            ...
            <div class="col-12 mb-3">
                @if (Auth::user()->havePermission('cafeto.admin-cashier.inventory.store'))
                    <button type="button" class="btn btn-success form-control text-truncate"
                        wire:click="registerEntry" wire:loading.attr="disabled">
