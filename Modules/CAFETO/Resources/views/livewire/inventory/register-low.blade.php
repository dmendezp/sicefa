    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-6">
                    <label
                        class="col-form-label col-form-label-sm">{{ trans('cafeto::inventory.Title_Form_Origin_Warehouse') }}</label>
                ...
                <div class="col-md-6">
                    <label
                        class="col-form-label col-form-label-sm">{{ trans('cafeto::inventory.Title_Form_Reponsibility_Low') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
            ...
            <form wire:submit.prevent="addProduct" method="POST">
                <div class="row align-items-end">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="form-label my-0">
                                <strong
                                    class="text-danger">*</strong>{{ trans('cafeto::inventory.Title_Form_Product') }}
                            </label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label
                                class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Lot_Number') }}</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label
                                class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Inventory_Code') }}</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="fa-solid fa-grip"></i>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label
                                class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Production_Date') }}</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label
                                class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Expiration_Date') }}</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="fa-solid fa-calendar-day"></i>
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label
                                        class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Price') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label
                                        class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Existing_Amount') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="fa-solid fa-grip"></i>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label my-0">
                                        <strong
                                            class="text-danger">*</strong>{{ trans('cafeto::inventory.Title_Form_Amount') }}
                                    </label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label
                                        class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Mark') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="fa-solid fa-grip"></i>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label
                                        class="form-label my-0">{{ trans('cafeto::inventory.Title_Form_Destination') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                            ...
                            <div class="col-md-4 my-auto">
                                <div class="form-group my-0">
                                    <button type="submit"
                                        class="btn btn-success btn-sm form-control">{{ trans('cafeto::inventory.Btn_Add_List') }}
                    ...
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="text-center"><i class="fa-solid fa-calendar-days"></i>
                                    {{ trans('cafeto::inventory.4T_Production_Date') }}</th>
                                <th class="text-center"><i class="fa-solid fa-calendar-days"></i>
                                    {{ trans('cafeto::inventory.4T_Expiration_Date') }}</th>
                                ...
                                <th class="text-center" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="{{ trans('cafeto::inventory.4T_Actions') }}">
    ...
    <div class="d-flex justify-content-evenly">
        <div class="row">
            <div class="col-12 mb-3">
                <button type="button" class="btn btn-danger form-control text-truncate" wire:click="registerLow"
