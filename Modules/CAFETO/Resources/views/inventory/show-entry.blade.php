        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">{{ trans('cafeto::inventory.Form_Title_Responsible_Delivery') }}</label>
                ...
                <div class="row mt-1">
                    <div class="col-md-4">
                        <label class="form-label">{{ trans('cafeto::inventory.Form_Title_Receiving_Warehouse') }}</label>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">{{ trans('cafeto::inventory.Form_Title_Responsible_Receiving') }}</label>
                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col" class="text-center">{{ trans('cafeto::inventory.5T_Number') }}</th>
                                <th scope="col">{{ trans('cafeto::inventory.5T_Product') }}</th>
                                <th scope="col" class="text-center">{{ trans('cafeto::inventory.5T_Amount') }}</th>
                                <th scope="col" class="text-center">{{ trans('cafeto::inventory.5T_Subtotal') }}</th>
                                <th scope="col" class="text-center">{{ trans('cafeto::inventory.5T_Total') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3"></td>
                                <td class="text-right fw-bold">{{ trans('cafeto::inventory.5T_Total:') }}</td>
