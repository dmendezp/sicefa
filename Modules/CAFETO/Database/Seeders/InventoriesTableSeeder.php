...
class InventoriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $warehouse = Warehouse::where('name','Estación de Café')->firstOrFail(); // Consultar bodega
        $productive_unit = ProductiveUnit::where('name','Estación de Café')->firstOrFail(); // Consultar unidad productiva
