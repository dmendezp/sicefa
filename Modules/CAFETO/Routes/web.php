...
Route::middleware(['lang'])->prefix('cafeto')->group(function () {
    ...
    Route::controller(InventoryController::class)->group(function () {
        ...
        Route::post('admin/reports/inventory/generatepdf', 'generateInventoryPDF')
            ->name('cafeto.admin.reports.inventory.generate.pdf');
        Route::post('cashier/reports/inventory/generatepdf', 'generateInventoryPDF')
            ->name('cafeto.cashier.reports.inventory.generate.pdf');

        Route::get('admin/reports/inventory/entries', 'showInventoryEntriesForm')
            ->name('cafeto.admin.reports.inventory.entries');
        Route::get('cashier/reports/inventory/entries', 'showInventoryEntriesForm')
            ->name('cafeto.cashier.reports.inventory.entries');

        Route::post('admin/reports/inventory/entries', 'generateInventoryEntries')
            ->name('cafeto.admin.reports.generate.inventory.entries');
        Route::post('cashier/reports/inventory/entries', 'generateInventoryEntries')
            ->name('cafeto.cashier.reports.generate.inventory.entries');

        Route::post('admin/reports/inventory/entries/generatepdf', 'generateInventoryEntriesPDF')
            ->name('cafeto.admin.reports.generate.entries.pdf');
        Route::post('cashier/reports/inventory/entries/generatepdf', 'generateInventoryEntriesPDF')
            ->name('cafeto.cashier.reports.generate.entries.pdf');
        ...
        Route::post('admin/reports/sales/generatepdf', 'generateSalesPDF')
            ->name('cafeto.admin.reports.generate.sales.pdf');
        Route::post('cashier/reports/sales/generatepdf', 'generateSalesPDF')
            ->name('cafeto.cashier.reports.generate.sales.pdf');
    ...
    // Rutas para Formulaciones (solo UNA definición coherente, sin duplicar)
    Route::controller(FormulationsController::class)->group(function () {
        ...
        // Admin aprobar (GET + POST) — corregido para que apunte a métodos reales del mismo controller
        Route::get('admin/formulations/{formulation}/aprobar', 'approve')->name('cafeto.admin.formulations.approve');
        Route::post('admin/formulations/{formulation}/aprobar', 'approveStore')->name('cafeto.admin.formulations.approve.store');
