                ...
                <!-- /.col-md-6 -->
                    <div class="col-lg-3">
                        <div class="card card-green card-outline shadow">
                            <div class="card-header">
                                <h5 class="m-0">{{ trans('hangarauto::developers.developers')}}</h5>
                            </div>
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset('modules/HANGARAUTO/img/Diego.png') }}"
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{ asset('modules/HANGARAUTO/img/Davidr.png') }}"
                                alt="User profile picture">
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card card-green card-outline shadow">
                            ...
                            <div class="card-body box-profile">
                                <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ asset('modules/HANGARAUTO/img/Sofiao.png') }}"
                                    alt="User profile picture">
                                </div>
