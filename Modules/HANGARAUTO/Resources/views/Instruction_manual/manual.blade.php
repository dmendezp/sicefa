...
@push('breadcrumbs')
    <li class="breadcrumb-item active">{{ trans('hangarauto::manual.Report_Indicator') }}</li>
@endpush
@section('content')
            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline shadow">
                    <div class="card-body text-center">
                        <h1 class="display-4 hero-title">{{ trans('hangarauto::manual.Title_Card_Manual') }}</h1>
                        <p class="lead hero_paragraph">{{ trans('hangarauto::manual.Subtitle_Card_Manual') }}</p>
                    </div>
                </div>
            </div>
        </div>
