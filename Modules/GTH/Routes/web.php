...
Route::middleware(['lang'])->group(function () {
    ...
    Route::prefix('gth')->group(function () {
        ...
        Route::get('/official', 'GTHController@viewofficial')->name('cefa.officials.view');
        ...
        Route::get('gth/employeetypes/{id}', [EmployeeTypController::class, 'showEmployeeType'])->name('cefa.gth.employeetypes.show');
        ...
        Route::get('gth/contractortypes/{id}', [ContractTypController::class, 'showContractorTypes'])->name('cefa.gth.contractortypes.show');
        ...
        Route::get('gth/insurerentities/{id}', [InsurerEntitiesController::class, 'showInsurerEntities'])->name('cefa.gth.insurerentities.show');
        ...
        Route::get('gth/pensionentities/{id}', [PensionEntitiesController::class, 'showPensionEntities'])->name('cefa.gth.pensionentities.show');
        ...
        Route::get('gth/contractors/{id}', [ContractorsController::class, 'showContractor'])->name('cefa.gth.contractor.show');
