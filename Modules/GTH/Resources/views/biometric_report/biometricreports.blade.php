...
@section('content')
                            ...
                            <td>
                                ...
                                @else
                                    <a href="#" class="btn btn-outline-secondary detalles-btn" data-bs-toggle="modal"
                                        ...
                                        data-nombre="{{ $person->first_name }} {{ $person->first_last_name }} {{ $person->second_last_name }}"
                                        data-documento="{{ $person->document_number }}"
                                        data-codigo-biometrico="{{ $person->biometric_code }}" data-estado="Registrado">Ver
                                        detalles</a>
                                @endif
                                @if (empty($person->biometric_code))
    ...
    @section('js')
        ...
        <!-- Script para el botón de búsqueda -->
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                searchButton.addEventListener('click', function() {
                    ...
                    filas.forEach(function(fila) {
                        const numeroDocumento = fila.querySelector('td:nth-child(2)').textContent.trim()
                            .toLowerCase();
