...
class PositionCompanyController extends Controller
{
    ...
    {    
        ...
        $data = ['title' => 'Cargos', 'position_companies' => $position_companies];
         return view('senaempresa::Company.Vacant.position', $data);
    }

    public function registro()
    {
        $position_companies = PositionCompany::all();
        $data = ['title' => 'registro', 'position_companies' => $position_companies];
        return view('senaempresa::Company.Vacant.position_registration', $data);
    }
...
public function store(Request $request)
{
 ...
 public function edit($id)
 {
    ...
    return view('senaempresa::Company.Vacant.position_edit', $data);
