    ...
    Route::prefix('senaempresa')->group(function () {
        ...
        Route::prefix('passant')->group(function () {
            ...
            Route::prefix('vacancies')->group(function () {
                ...
                Route::get('/new', 'VacantController@new')->name('senaempresa.passant.vacancies.new');
            
                //RUTAS PARA REALIZAR LA INSCRIPCIÓN A LAS VACANTES DISPONIBLES SEGUN EL CURSO DE SENAEMPRESA
                Route::get('/inscription/{vacancy_id}', 'PostulateController@inscription')->name('senaempresa.passant.vacancies.inscription');
                Route::post('/registered', 'PostulateController@registered')->name('senaempresa.passant.vacancies.registered');
            });
