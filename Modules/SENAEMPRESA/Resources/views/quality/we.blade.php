        ...
        <div class="content-wrapper">
            ...
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="my-card"> <img class="my-card-img"
                                src="{{ asset('senaempresa/images/Acuicultura.jpg') }}" />
                            <div class="my-card-body trainer-card-body">
                ...
                <div class="row">
                    <div class="col">
                        <div class="my-card"> <img class="my-card-img"
                                src="{{ asset('senaempresa/images/Ambiental.jpg') }}" />
                            <div class="my-card-body trainer-card-body">
                    ...
                    <div class="col">
                        <div class="my-card"> <img class="my-card-img"
                                src="{{ asset('senaempresa/images/Alimentos.jpg') }}" />
                            <div class="my-card-body trainer-card-body">
                    ...
                    <div class="col">
                        <div class="my-card"> <img class="my-card-img"
                                src="{{ asset('senaempresa/images/Mercados.jpg') }}" />
                            <div class="my-card-body trainer-card-body">
