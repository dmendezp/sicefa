            ...
            <div class="card card-primary card-outline shadow">
                ...
                <div class="card-body">
                    <form
                        ...
                        @csrf
                        <div class="mb-3">
                            <label for="apprentice_info" class="form-label">{{ trans('senaempresa::menu.Apprentice')
                                }}</label>
                        ...
                        <div class="mb-3">
                            <label for="vacancy_info" class="form-label">{{ trans('senaempresa::menu.Vacancy ID')
                                }}</label>
                        ...
                        <div class="mb-3">
                            <label for="personalities" class="form-label">{{ trans('senaempresa::menu.16 personalities')
                                }}</label><br>
                            <input type="file" id="personalities" name="personalities" accept=".pdf" required>
                        </div>
                        <div class="mb-3">
                            <label for="proposal" class="form-label">{{ trans('senaempresa::menu.Proposal')
                                }}</label><br>
