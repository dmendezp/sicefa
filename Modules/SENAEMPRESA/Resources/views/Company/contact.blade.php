                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ asset('storage/photos/shares/people/Diego.png') }}" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center">Diego Andres Mendez Pastrana</h3>
                            <p class="text-muted text-center">Instructor - Tgo. Analisis y desarollo de sistemas de
                                información</p>
                ...
                <div class="col-lg-4">
                    <div class="card card-primary card-outline shadow">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="{{ asset('sica/images/logofs.png') }}" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center">Fabrica de Software</h3>
                            <p class="text-muted text-center">Unidad productiva - Tgo. Analisis y desarollo de sistemas de
                                información</p>
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Facebook</b> <a href="#" class="btn btn-outline-primary float-right"><b><i
