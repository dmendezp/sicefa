                ...
                <div class="card-body">
                    <form action="{{ route('company.senaempresa.nuevo_personal') }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="position_company_id" aria-label="Selecciona un Cargo" required>
                        ...
                        <div class="mb-3">
                            <label for="apprentice_id" class="form-label">Buscar Aprendiz por Documento o Nombre</label>
                            <input type="text" class="form-control" id="search-input" name="search-input" placeholder="Ingresar número o nombre">
                            <select class="form-control" name="apprentice_id" aria-label="Selecciona un Aprendiz" id="apprentice-select" multiple="multiple" required>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">Imagen Personal</label><br>
