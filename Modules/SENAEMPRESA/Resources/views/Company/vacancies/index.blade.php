                ...
                <table id="datatable" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            Auth::user()->havePermission('senaempresa.' . getRoleRouteName(Route::currentRouteName()) .
                            '.vacancies.new'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @if (Route::is('senaempresa.admin.*') || (Route::is('senaempresa.apprentice.*') &&
                                Auth::user()->havePermission('senaempresa.' .
                                getRoleRouteName(Route::currentRouteName()) . '.vacancies.inscription')))
