...
class SENAEMPRESADatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->call(InventoriesTableSeeder::class); // Ejecutar Seeder de permisos para roles
        ...
        $this->call(VacanciesTableSeeder::class); // Ejecutar Seeder de permisos para role
