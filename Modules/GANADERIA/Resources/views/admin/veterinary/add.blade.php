        ...
        <div class="col-lg-12">
          <div class="card card-success card-outline">
            <div class="card-header">
              <h3 class="m-0">{{ trans('ganaderia::vet.Add') }} {{ trans('ganaderia::vet.Register') }}</h3>
            </div>
            <div class="card-body">
              <form action="{{ route('ganaderia.admin.vet.addpost') }}" method="post">
                @csrf
                <!-- inicio del inventario -->
                <div class="form-group">
                  <label for="inven">{{ trans('ganaderia::vet.Inventario usado') }}</label>
                  {!! Form::select('inventory_id',$inven, [],['class' => 'form-control','placeholder' => 'Seleccione...','required']) !!}
                </div>
                <!-- fin del inventario -->
                <!-- inicio del animal que se le hizo el tratamiento -->
                <div class="form-group">
                  <label for="animal">{{ trans('ganaderia::vet.animal que se trato') }}</label>
                  {!! Form::select('animal_id',$animal, [],['class' => 'form-control','placeholder' => 'Seleccione...','required']) !!}
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="treat" id="treat">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="obser" id="obser">
                </div>
