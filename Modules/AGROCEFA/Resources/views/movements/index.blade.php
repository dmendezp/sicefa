...
@section('content')
    ...
    <div class="container" style="margin-top: 100px">
        <div class="row justify-content-between">
                ...
                <a class="card credentialing" href="{{ route('agrocefa.formentrance') }}">
                    ...
                    <div class="circle">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1"
                            ...
                            <g transform="translate(27.000000, 21.000000)" fill-rule="evenodd" fill="none"
                                stroke-width="1" stroke="none" id="Group-12">
                                <g id="Group-5">
                                    <g transform="translate(2.262327, 21.615176)" id="Group-3">
                                        <mask fill="white" id="mask-2">
                                        </mask>
                                        <g id="Clip-2"></g>
                                        <path mask="url(#mask-2)" fill="#59A785" id="Fill-1"
                                    ...
                                    <polygon
                                        ...
                                        fill="#FFFFFF" id="Fill-4"></polygon>
                                    <ellipse ry="9.17325562" rx="9.95169733" cy="21.7657707" cx="30.0584472"
                                        opacity="0.216243004" fill="#25D48A" id="Oval-3"></ellipse>
            ...
            {{-- fin primera tarjeta de entrada --}}


            {{-- segunda tarjeta de salida --}}
            <div class="col-md-5">
                <a class="card credentialing" href="{{ route('agrocefa.formexit') }}">
                    <div class="overlay"></div>
                    <div class="circle">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1"
                            viewBox="27 21 64 72" height="72px" width="64px">
        ...
        {{-- fin segunda tarjeta de salida --}}
    </div>


    {{-- estilos de las dos tarjetas --}}
    <style>
        .credentialing {
            --bg-color: #695CFE;
        ...
        .col-md-5 {
            width: 48%;
            /* Controla el ancho de cada tarjeta */
        }
    </style>
@endsection
