    ...
    $(document).ready(function() {
        ...
        function addProductRow() {
            ...
            newRow.html(
                ...
                '<td class="col-2"><select id="product-id" class="form-control product-id" name="product-id[]" required><option value="">Seleccione la Herramienta</option>@foreach ($machineryOptions as $machineryId => $machineryName)<option value="{{ $machineryId }}">{{ $machineryName }}</option>@endforeach</select></td>' +
        ...
        machineryTable.on('change', 'select[name="product-id[]"]:last', function() {
        ...
        machineryTable.on('change', 'select[name="product-id[]"]', function() {
            var currentRow = $(this).closest('tr');
        ...
        machineryTable.on('input', 'input[name="product-quantity[]"]', function() {
            var currentRow = $(this).closest('tr');
