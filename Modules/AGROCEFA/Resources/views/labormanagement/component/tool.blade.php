    ...
    $(document).ready(function() {
        ...
        function addProductRow() {
            ...
            newRow.html(
                ...
                '<td class="col-2"><select id="product-id" class="form-control product-id" name="product-id[]" required><option value="">Seleccione la Herramienta</option>@foreach ($toolOptions as $toolId => $toolName)<option value="{{ $toolId }}">{{ $toolName }}</option>@endforeach</select></td>' +
        ...
        toolTable.on('change', 'select[name="product-id[]"]:last', function() {
        ...
        toolTable.on('change', 'select[name="product-id[]"]', function() {
            var currentRow = $(this).closest('tr');
        ...
        toolTable.on('input', 'input[name="product-quantity[]"]', function() {
            var currentRow = $(this).closest('tr');
