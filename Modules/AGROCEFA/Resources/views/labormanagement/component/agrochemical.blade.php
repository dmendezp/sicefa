    ...
    $(document).ready(function() {
        ...
        function addProductRow() {
            ...
            newRow.html(
                ...
                '<td class="col-2"><select id="product-id" class="form-control product-id" name="product-id[]" required><option value="">Seleccione la Herramienta</option>@foreach ($agrochemicalOptions as $agrochemicalId => $agrochemicalName)<option value="{{ $agrochemicalId }}">{{ $agrochemicalName }}</option>@endforeach</select></td>' +
