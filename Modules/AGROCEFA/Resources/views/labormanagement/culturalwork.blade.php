        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select(
                                'lot',
                                ['' => 'Seleccione el Lote'] + collect($environmentData)->pluck('name', 'id')->toArray(),
                                old('lot'),
                    ...
                    <button type="button" id="toggleInfo" class="btn btn-primary">Mostrar Información
                        Adicional</button>
                </div>
                <br>
                ...
                <script>
                    ...
                    // Manejar el evento de clic en el botón para desplegar/cerrar la información adicional
