    ...
    <main>
        ...
        <body>
            ...
            <header class="hero">
                <nav class="nav container">
                    ...
                    <ul class="nav_link nav_link--menu">
                        ...
                        <img src="{{ asset('agrocefa/images/usuario/close.svg') }}" class="nav_close" >
                    </ul>
                    <img src="{{ asset('agrocefa/images/usuario/menu.svg') }}" class="nav_close" >
                </nav>
                </nav>
            ...
            <section class="container about" id="r">
                <h2 class="subtitle"><img src="{{ asset('agrocefa/images/usuario/hoja.png') }}" alt="Cerco Horizontal"
                        class="cerco-horizontal">{{trans('agrocefa::vusuario.What will you discover in this section?')}}<img
                        src="{{ asset('agrocefa/images/usuario/hoja.png') }}" alt="Cerco Horizontal"
            ...
            <section>
                <div class="knowledge_container container" id="proposito">
                    ...
                    <div class="knowledge_texts">
                        <h2 class="subtitle"><img src="{{ asset('agrocefa/images/usuario/hoja.png') }}"
            ...
            <section class="testimony" id="clasificacion">
                <div class="testimony_container container">
                    ...
                    <img src="{{ asset('agrocefa/images/usuario/derecha.svg') }}" class="testimony_arrow"
                        id="next">
                </div>
            </section>
            {{-- mision --}}
                ...
                <div class="knowledge_container container" id="mision">
                    ...
                    <div class="knowledge_pictures">
                        <div class="image-container">
                            <img src="{{ asset('agrocefa/images/usuario/img9.jpg') }}" class="knowledge_img1"
                                id="imagen1">
                            <img src="{{ asset('agrocefa/images/usuario/img10.jpg') }}" class="knowledge_img2"
                                id="imagen2">
                        </div>
                    </div>
                </div>
            ...
            <section class="knowledge" id="vision">
                <div class="knowledge_container container">
                    <figure class="knowledge_picture">
                        <div class="knowledge_pictures">
                            <div class="image-container">
                                <img src="{{ asset('agrocefa/images/usuario/img6.jpg') }}" class="knowledge_img1"
                                    id="imagen1">
                                <img src="{{ asset('agrocefa/images/usuario/img11.jpg') }}" class="knowledge_img2"
                                    id="imagen2">
                            </div>
                    </figure>
                    <div class="knowledge_texts">
                        <h2 class="subtitle">
                            <img src="{{ asset('agrocefa/images/usuario/hoja.png') }}" alt="Cerco Horizontal"
                                class="cerco-horizontal">
