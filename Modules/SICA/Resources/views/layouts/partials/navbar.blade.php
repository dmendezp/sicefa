              ...
              @if (checkRol('sica.admin'))
                  <li class="nav-item d-none d-sm-inline-block mr-1 {{ !Route::is('*admin.*') ?: 'active' }}">
                      <a href="{{ route('sica.admin.dashboard') }}"
                          class="nav-link">{{ trans('sica::menu.Administrator') }}</a>
                  </li>
              @endif
              @if (checkRol('sica.attendance'))
                  <li class="nav-item d-none d-sm-inline-block mr-1 {{ !Route::is('*attendance.*') ?: 'active' }}">
                      <a href="{{ route('sica.attendance.dashboard') }}"
                          class="nav-link">{{ trans('sica::menu.Attendance') }}</a>
                  </li>
              @endif
          @endguest
      ...
      <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="#"
                      class="dropdown-item dropdown-footer">{{ trans('modulo1::menu.See All Notifications') }}</a>
              </div>
          </li>
          <li class="nav-item">
