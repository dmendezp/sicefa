          ...
          <nav class="mt-2">
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  @if (Route::is('*admin.*'))
                      <li class="nav-item">
                          <a href="{{ route('sica.admin.dashboard') }}"
                              class="nav-link {{ !Route::is('sica.admin.dashboard') ?: 'active' }}">
                      ...
                      <li class="nav-item {{ !Route::is('sica.admin.people.*') ?: 'menu-is-opening menu-open' }}">
                          ...
                          <ul class="nav nav-treeview">
                              @if (Auth::user()->havePermission('sica.admin.people.config'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.people.config') }}"
                                          class="nav-link {{ !Route::is('sica.admin.people.config*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.people.personal_data'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.people.personal_data') }}"
                                          class="nav-link {{ !Route::is('sica.admin.people.personal_data*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.people.apprentices'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.people.apprentices') }}"
                                          class="nav-link {{ !Route::is('sica.admin.people.apprentices*') ?: 'active' }}">
                              ...
                              @endif
                              <li class="nav-item">
                                  <a href="{{ route('sica.admin.people.instructors') }}"
                              ...
                              <li class="nav-item">
                                  <a href="{{ route('sica.admin.people.officers') }}"
                                      class="nav-link {{ !Route::is('sica.admin.people.officers*') ?: 'active' }}">
                                      <i class="fas fa-id-card"></i>
                                      <p>{{ trans('sica::menu.Officers') }}</p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="{{ route('sica.admin.people.contractors') }}"
                              ...
                              @if (Auth::user()->havePermission('sica.admin.people.events_attendance'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.people.events_attendance') }}"
                                          class="nav-link {{ !Route::is('sica.admin.people.events_attendance*') ?: 'active' }}">
                      ...
                      <li class="nav-item {{ !Route::is('sica.admin.academy.*') ?: 'menu-is-opening menu-open' }}">
                          ...
                          <ul class="nav nav-treeview">
                              @if (Auth::user()->havePermission('sica.admin.academy.quarters'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.academy.quarters') }}"
                                          class="nav-link {{ !Route::is('sica.admin.academy.quarters*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.academy.programs'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.academy.programs') }}"
                                          class="nav-link {{ !Route::is('sica.admin.academy.programs*') ?: 'active' }}">
                      ...
                      <li class="nav-item {{ !Route::is('sica.admin.location.*') ?: 'menu-is-opening menu-open' }}">
                          ...
                          <ul class="nav nav-treeview">
                              @if (Auth::user()->havePermission('sica.admin.location.countries'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.location.countries') }}"
                                          class="nav-link {{ !Route::is('sica.admin.location.countries*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.location.farms'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.location.farms') }}"
                                          class="nav-link {{ !Route::is('sica.admin.location.farms*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.location.environments'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.location.environments') }}"
                                          class="nav-link {{ !Route::is('sica.admin.location.environments*') ?: 'active' }}">
                          ...
                          <ul class="nav nav-treeview">
                            ...
                            @endif
                              @if (Auth::user()->havePermission('sica.admin.inventory.warehouse.index'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.inventory.warehouse.index') }}"
                                          class="nav-link {{ !Route::is('sica.admin.inventory.warehouse.*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.inventory.elements'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.inventory.elements') }}"
                                          class="nav-link {{ !Route::is('sica.admin.inventory.elements*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.inventory.transactions'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.inventory.transactions') }}"
                                          class="nav-link {{ !Route::is('sica.admin.inventory.transactions*') ?: 'active' }}">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.inventory.inventory'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.inventory.inventory') }}"
                                          class="nav-link {{ !Route::is('sica.admin.inventory.inventory*') ?: 'active' }}">
                      ...
                      <li class="nav-item {{ !Route::is('sica.admin.security.*') ?: 'menu-is-opening menu-open' }}">
                          ...
                          <ul class="nav nav-treeview">
                              ...
                              @if (Auth::user()->havePermission('sica.admin.security.users.index'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.admin.security.users.index') }}"
                                          class="nav-link {{ !Route::is('sica.admin.security.users.*') ?: 'active' }}">
                      ...
                      <li
                          ...
                          <ul class="nav nav-treeview">
                              @if (Auth::user()->havePermission('sica.attendance.people.events_attendance'))
                                  <li class="nav-item">
                                      <a href="{{ route('sica.attendance.people.events_attendance') }}"
                                          class="nav-link {{ !Route::is('sica.attendance.people.events_attendance*') ?: 'active' }}">
                                          <i class="fa-solid fa-clipboard-user"></i>
                                          <p>{{ trans('sica::menu.Events attendance') }}</p>
                                      </a>
                                  </li>
