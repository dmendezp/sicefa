...
<div id="content-config">
    ...
    {!! Form::open(['route'=>'sica.'.$role_name.'.people.config.eps.destroy', 'method'=>'POST', 'id'=>'form-config']) !!}
        ...
        <div class="modal-footer py-1">
            ...
            @if (Auth::user()->havePermission('sica.'.$role_name.'.people.config.eps.destroy'))
