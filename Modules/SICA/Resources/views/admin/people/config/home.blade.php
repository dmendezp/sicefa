                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a data-toggle="modal" data-target="#generalModal"
                                                    onclick="ajaxAction('{{ route('sica.admin.people.config.eps.add') }}')">
                                                    <b class="text-success" data-toggle="tooltip" data-placement="top"
                                                        title="Agregar">
                                        ...
                                        @foreach ($epss as $eps)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="opts">
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.eps.edit') }}/{{ $eps->id }}')">
                                                            <b class="text-info" data-toggle="tooltip" data-placement="top"
                                                                title="Editar">
                                                                <i class="fas fa-edit"></i>
                                                            </b>
                                                        </a>
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.eps.delete') }}/{{ $eps->id }}')">
                                ...
                                <table id="example2" class="display table table-bordered table-striped table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nombre</th>
                                            <th>Descripción</th>
                                            <th><a href="" class="text-success" data-toggle='tooltip'
                                            ...
                                            <td>
                                                <div class="opts">
                                                    ...
                                                    <a class="text-danger btn-delete" href="#" data-action="delete"
                                                        data-toggle='tooltip' data-placement="top" data-object=""
                                                        data-path="sica/admin/people/apprentice" title="Eliminar"><i
                                ...
                                <table id="example2" class="display table table-bordered table-striped table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <a data-toggle="modal" data-target="#generalModal"
                                                    onclick="ajaxAction('{{ route('sica.admin.people.config.population.add') }}')">
                                                    <b class="text-success" data-toggle="tooltip" data-placement="top"
                                                        title="Agregar">
                                                        <i class="fas fa-plus-circle"></i>
                                                    </b>
                                        ...
                                        @foreach ($populations as $population)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="opts">
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.population.edit') }}/{{ $population->id }}')">
                                                            <b class="text-info" data-toggle="tooltip"
                                                                data-placement="top" title="Editar">
                                                                <i class="fas fa-edit"></i>
                                                            </b>
                                                        </a>
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.population.delete') }}/{{ $population->id }}')">
                                                            <b class="text-danger" data-toggle="tooltip"
                                                                data-placement="top" title="Eliminar">
                                                                <i class="fas fa-trash-alt"></i>
                                                            </b>
                                ...
                                <table id="example2" class="display table table-bordered table-striped table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <a data-toggle="modal" data-target="#generalModal"
                                                    onclick="ajaxAction('{{ route('sica.admin.people.config.event.add') }}')">
                                                    <b class="text-success" data-toggle="tooltip" data-placement="top"
                                                        title="Agregar">
                                                        <i class="fas fa-plus-circle"></i>
                                                    </b>
                                        ...
                                        @foreach ($events as $event)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="opts">
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.event.edit') }}/{{ $event->id }}')">
                                                            <b class="text-info" data-toggle="tooltip"
                                                                data-placement="top" title="Editar">
                                                                <i class="fas fa-edit"></i>
                                                            </b>
                                                        ...
                                                        <a data-toggle="modal" data-target="#generalModal"
                                                            onclick="ajaxAction('{{ route('sica.admin.people.config.event.delete') }}/{{ $event->id }}')">
                                                            <b class="text-danger" data-toggle="tooltip"
                                                                data-placement="top" title="Eliminar">
                                                                <i class="fas fa-trash-alt"></i>
                                                            </b>
