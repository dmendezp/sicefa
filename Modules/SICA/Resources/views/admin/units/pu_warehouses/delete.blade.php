<div id="content-config">
    ...
    {!! Form::open(['route'=>'sica.' . getRoleRouteName(Route::currentRouteName()) . '.units.pu_warehouses.destroy', 'method'=>'POST', 'id'=>'form-config']) !!}
        <div class="modal-body px-4 pt-3" style="font-size: 20px;">
            ...
            <div class="row">
                <div class="col-4 text-right"><b>Unidad Productiva</b></div>
                <div class="col-8">{{ $puw->productive_unit->name }}</div>
            </div>
            <div class="row">
                <div class="col-4 text-right"><b>Bodega</b></div>
                <div class="col-8">{{ $puw->warehouse->name }}</div>
            </div>
