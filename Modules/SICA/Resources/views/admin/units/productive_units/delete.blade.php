<div id="content-config">
    ...
    {!! Form::open(['route'=>'sica.admin.units.productive_unit.destroy', 'method'=>'POST', 'id'=>'form-config']) !!}
        ...
        <div class="modal-footer py-1">
            ...
            @if (Auth::user()->havePermission('sica.admin.units.productive_unit.destroy'))
