...
{!! Form::label('start_date', trans('sica::menu.Start Date'), ['class' => 'mt-3']) !!}
<div class="input-group">
    <div class="input-group-prepend">
        <span class="input-group-text">
    ...
    {!! Form::date('start_date', isset($course) ? $course->start_date : null, ['class' => 'form-control', 'required']) !!}
</div>
...
{!! Form::label('start_production_date', trans('sica::menu.Start Productive'), ['class' => 'mt-3']) !!}
<div class="input-group">
    <div class="input-group-prepend">
        <span class="input-group-text">
            <i class="fa-solid fa-calendar-days"></i>
    ...
    {!! Form::date('start_production_date', isset($course) ? $course->start_production_date : null, ['class' => 'form-control', 'required']) !!}
</div>
