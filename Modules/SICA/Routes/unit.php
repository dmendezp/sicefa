...
Route::middleware(['lang'])->group(function(){
    ...
    Route::prefix('sica')->group(function() {
        ...
        Route::get('/admin/units/pu_warhouses/delete/{id}', [UnitController::class, 'pu_warehouses_delete'])->name('sica.admin.units.pu_warehouses.delete'); // Formulario de eliminacion de la unidad productiva  (Administrador)
        Route::post('/admin/units/pu_warhouses/destroy/', [UnitController::class, 'pu_warehouses_destroy'])->name('sica.admin.units.pu_warehouses.destroy'); // Eliminar unidad productiva (Administrador)
