<nav class="navbar navbar-expand-lg navbar-Dark" style="background-color:rgb(247, 244, 244); margin-bottom:20px">
    ...
    <div class="collapse navbar-collapse d-sm-flex" id="collapsibleNavId">
        <ul class="navbar-nav me-auto mt-2 mt-lg-0">
            <li class="nav-item">
                <a class="nav-link" href="{{route('agroindustria.instructor.index')}}">Inicio</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('agroindustria.instructor.unidd')}}">Unidades</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('agroindustria.instructor.solicitud')}}">Solicitud</a>
            </li>
        </ul>
    </div>
