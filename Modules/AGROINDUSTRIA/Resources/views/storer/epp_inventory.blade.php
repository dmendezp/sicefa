    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">AGREGAR ELEMETO DE EPP</h1>
            ...
            <tbody>
                ...
                <td>
                    <th>
                      ...
                      <button type="button" class="btn btn-Danger" id="delete" data-bs-toggle="modal" data-bs-target="#">
                         <i class="fa-solid fa-trash fa-2xl"></i>
                      </button>

                      {{-- Modal de edicion de insumos --}}
