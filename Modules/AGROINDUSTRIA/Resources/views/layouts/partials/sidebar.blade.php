<div class="sidebar-color">
    <aside class="main-sidebar sidebar-dark-blue elevation-4">
        ...
        <a href="{{ route('cefa.agroindustria.home.index') }}" class="brand-link text-decoration-none">
            <img src="{{ asset('modules/sigac/images/icon/logo_sigac.png') }}" class="brand-image"
                alt="SIGAC_Logo">{{-- Icono de SIGAC --}}
            <span class="brand-text">AGROINDUSTRIA</span>
        </a>
        ...
        <div class="sidebar">
                ...
                @else
                    <div class="col info info-user">
                        <div data-toggle="tooltip" data-placement="top"
                            ...
                            <div style="color:#000000a0">{{ Auth::user()->nickname }}</div>
                        </div>
                        <div class="small" style="color:#000000a0">
                    ...
                    <div class="col-auto info float-right mt-2">
                        <a href="{{ route('logout') }}" class="d-block" data-bs-toggle="tooltip" data-bs-placement="right"
                            ...
                            <i class="fas fa-sign-out-alt" style="color: #000000a0"></i>
                        </a>
                    </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if (Route::is('cefa.agroindustria*'))
                        <li class="nav-item">
                            <a href="{{ route('cefa.agroindustria.home.index') }}"
                                class="nav-link {{ !Route::is('cefa.agroindustria.index*') ?: 'active' }}">
