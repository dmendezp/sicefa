<form method="POST" action="{{ route('hdc.guardar.valores') }}">
    @csrf
                    ...
                    @foreach ($aspects[0]['environmental_aspects'] as $aspecto)
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="aspecto[{{ $aspecto['id'] }}][amount]" class="form-control" type="number" placeholder="{{ $aspecto['measurement_unit']['name'] }}" required>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
