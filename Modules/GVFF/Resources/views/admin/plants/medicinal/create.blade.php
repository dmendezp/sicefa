@extends('gvff::layouts.master')
   ...
   @section('content')
   <div class="container">
       <h1><i class="fas fa-mortar-pestle me-2"></i> Crear Planta Medicinal</h1>
       <form action="{{ route('gvff.admin.plants.medicinal.store') }}" method="POST" enctype="multipart/form-data">
           @csrf
           <input type="hidden" name="plant_type" value="medicinal">
