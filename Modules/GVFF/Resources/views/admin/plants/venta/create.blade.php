@extends('gvff::layouts.master')
   ...
   @section('content')
   <div class="container">
       <h1><i class="fas fa-shopping-cart me-2"></i> Crear Planta en Venta</h1>
       <form action="{{ route('gvff.admin.plants.venta.store') }}" method="POST" enctype="multipart/form-data">
           @csrf
           <input type="hidden" name="plant_type" value="venta">
