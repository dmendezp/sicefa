...
<li class="breadcrumb-item active">
  <a href="{{ route('evs.admin.dashboard') }}"><i class="fas fa-calendar-alt"></i> {{ __('Elections') }}</a>
</li>
@endsection
      ...
      <div class="container-fluid">
			...
			<div class="card card-purple card-outline shadow">
              <div class="card-header">
                <h3 class="card-title">{{ __('Elections') }}</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              	<div class="btns">
				<a href="{{ route('evs.admin.elections.add') }}" class="btn btn-primary"><i class="fas fa-calendar-plus"></i> {{ __('Elections Add') }}</a>
				</div>
				<div class="mtop16">
