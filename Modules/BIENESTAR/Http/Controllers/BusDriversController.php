...
class BusDriversController extends Controller
{
    ...
    public function driversUp(Request $request, $id)
    {
        ...
        if (!$busdriver) {
            return redirect()->route('bienestar.admin.crud.drivers')->with('error', 'El conductor no existe.');
        }
        ...
        return redirect()->route('bienestar.admin.crud.drivers')->with('success', 'Conductor actualizado con éxito');
    }
