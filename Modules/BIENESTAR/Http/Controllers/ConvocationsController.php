...
class ConvocationsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($convocations->save()){
            return redirect()->route('bienestar.admin.convocations.crud.convocations')->with('message', 'Convocatoria registrada Correctamente')->with('typealert', 'success');
        }else{
            return redirect()->route('bienestar.admin.convocations.crud.convocations')->with('message', 'Se Ha Producido Un Error')->with('typealert', 'danger');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($convocations->save()){
            return redirect()->route('bienestar.admin.convocations.crud.convocations')->with('message', 'Registro Actualizado Correctamente')->with('typealert', 'success');
        }
        return redirect()->route('bienestar.admin.convocations.crud.convocations')->with('message', 'Se Ha Producido Un Error')->with('typealert', 'danger');
    }
