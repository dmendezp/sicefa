        ...
        <div class="card shadow">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="question_{{ $question->id }}" name="question[]" value="{{ $question->id }}" readonly>
                    <select class="form-control" id="answer_{{ $question->id }}" name="answer[]">
