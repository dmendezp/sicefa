            ...
            <div class="row d-flex justify-content-center">
                <div class="card card-blue card-outline shadow col-md-6">
                    <div class="card-header">
                        <h3 class="card-title">Cargar juicio evaluativo</h3>
                    </div>
                    <div class="card-body">
                        {!! Form::open([ 'url' => route('sigac.academic_coordination.curriculum_planning.evaluative_judgment.load.store'), 'files' => 'true', 'enctype' => 'multipart/form-data']) !!}
