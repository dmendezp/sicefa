...
<body>
    @php
        ...
        $title = $isCanceled
            ...
            : (($event ?? '') === 'rescheduled'
                ? 'La visita fue reprogramada'
                : 'La visita fue actualizada');
    @endphp
    <div class="wrap">
        <div class="card">
            <h2>{{ $title }}</h2>
            <div class="section">
                ...
                <ul>
                    ...
                    <li><strong>Fecha / Hora:</strong> {{ $visitSchedule->date }} |
                        {{ $visitSchedule->start_time }}–{{ $visitSchedule->end_time }}</li>
                    ...
                    @if ($visitSchedule->personInCharge)
                        <li><strong>Encargado:</strong>
                            {{ $visitSchedule->personInCharge->first_name }}
                            {{ $visitSchedule->personInCharge->first_last_name }}
                        </li>
                    @endif
                </ul>
