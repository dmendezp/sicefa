                ...
                <tbody>
                    @forelse($visitRequests as $visit)
                        @php
                            ...
                            $existsNew    = $excelPath && \Illuminate\Support\Facades\Storage::disk('sigac_visit')->exists($excelPath);
                                    ...
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content">
                                            <form method="POST" action="{{ route('sigac.academic_coordination.visitschedule.cancel', $scheduleId) }}">
                                                ...
                                                <div class="modal-body">
                                                    <label class="form-label">{{ trans('sigac::visits.fields.reason') }} ({{ trans('sigac::visits.common.optional') }})</label>
                                                    <textarea name="reason" rows="3" class="form-control" placeholder="{{ trans('sigac::visits.fields.reason_ph') }}"></textarea>
