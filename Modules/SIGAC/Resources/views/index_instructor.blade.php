...
@section('content')
    ...
    <div class="d-flex justify-content-end mb-3">
        <!-- Botón Ayuda -->
        <a href="{{ asset('manuales/Manual_Usuario_Instructor.pdf') }}" target="_blank" class="btn btn-primary" title="Ver manual de usuario" style="width: 10%">
            <i class="fa-solid fa-circle-question"></i> Ayuda
        </a>

        <!-- Botón Descargar Manual con ícono de libro -->
        <a href="{{ asset('manuales/Manual_Usuario_Instructor.pdf') }}" download class="btn btn-primary ms-2" title="Descargar manual de usuario" style="width: 10%">
