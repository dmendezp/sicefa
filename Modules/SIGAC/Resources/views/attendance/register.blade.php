                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="environment"
                                    class="form-label">{{ trans('sigac::attendance.CardSubtitle1') }}</label>
                            ...
                            <div class="mb-3">
                                <label for="technologist"
                                    class="form-label">{{ trans('sigac::attendance.CardSubtitle2') }}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            ...
                                            {{ trans('sigac::attendance.Register Previous') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
