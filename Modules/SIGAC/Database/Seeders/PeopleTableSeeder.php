...
class PeopleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Person::firstOrCreate(['document_number' => 1079174055], [ // Consultar o registrar Persona
            'document_type' => 'Cédula de ciudadanía',
            'first_name' => 'DUVAN FELIPE',
            'first_last_name' => 'TRUJILLO',
        ...
        Person::firstOrCreate(['document_number' => 12201071], [ // Consultar o registrar Persona
            'document_type' => 'Cédula de ciudadanía',
            'first_name' => 'WILLIAM JAVIER',
            'first_last_name' => 'MATIZ',
            'second_last_name' => 'CARVAJAL',
            'eps_id' => $eps->id,
            'population_group_id' => $population_group->id,
            'pension_entity_id' => $pension_entity->id
        ]);
