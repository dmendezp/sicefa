...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     /*   $person = Person::where('document_number', 36281368)->first(); // Consultar Persona
        ...
        $person = Person::where('document_number', 12201071)->first(); // Consultar Persona
        User::updateOrCreate(['nickname' => 'JWMATIZ'], [ // Actualizar o crear usuario
            'person_id' => 146407 ,
            'email' => 'matiz123@gmail.com'//Wima1071
        ]);
