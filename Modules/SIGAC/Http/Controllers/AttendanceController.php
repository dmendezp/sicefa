...
class AttendanceController extends Controller
{
    ...
    public function attendance_index() {
        ...
        $list = InstructorProgram::with('course.apprentices.person.attendance_apprentices')
            ...
            ->where('date', $date) // Aseguramos que la fecha sea solo la fecha actual
            ->whereTime('start_time', '<=', $currentTime) // Comparamos solo la hora actual
            ->whereTime('end_time', '>=', $currentTime) // Comparamos solo la hora actual
            ->get();
