...
class SIGACController extends Controller
{
    ...
    public function security_dashboard(){
        $view = ['titlePage'=>trans('sigac::controllers.SIGAC_security_dashboard_title_page'), 'titleView'=>trans('sigac::controllers.SIGAC_security_dashboard_title_view')];
        return view('sigac::index_wellness', $view);
    }
}   