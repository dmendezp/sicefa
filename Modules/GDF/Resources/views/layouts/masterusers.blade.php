...
<head>
    ...
    <link rel="icon" href="{{ asset('modules/gdf/images/Contacto/Mamacita.jpg') }}" type="image/x-icon">
    <title>Gestión de Desplazamiento de Funcionario</title>
            ...
            @auth
                @if(checkRol('gdf.admin'))
                    <li class="nav-item d-none d-sm-inline-block" style="margin-right: 80px;">
                        <a href="{{ route('cefa.admin.welcome') }}" 
                           class="nav-link @if(Route::is('cefa.admin.*')) active @endif">
                            Administrador
                        </a>
                    </li>
                @endif
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center mt-5">
                        <h1 class="display-4">Bienvenido a Gestión de Desplazamiento de Funcionarios</h1>
                        <p class="lead">
