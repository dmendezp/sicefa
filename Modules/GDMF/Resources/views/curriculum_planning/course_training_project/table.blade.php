                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form id="delete-training_project-form-{{ $training_project->id }}{{ $course->id }}"
                            action="{{ route('gdmf.academic_coordination.curriculum_planning.course_trainig_project.destroy', ['training_project_id' => $training_project->id, 'course_id' => $course->id]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
