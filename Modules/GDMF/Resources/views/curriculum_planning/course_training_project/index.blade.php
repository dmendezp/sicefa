    ...
    <div class="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-center">
                <div class="card card-menta card-outline shadow col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 pr-3 pb-3">
                                <form action="{{ route('gdmf.academic_coordination.curriculum_planning.course_trainig_project.store') }}" method="post">
                                    @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.training_project_select').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('gdmf.academic_coordination.curriculum_planning.course_trainig_project.table') }}",
                data: {
                    _token: "{{ csrf_token() }}",
