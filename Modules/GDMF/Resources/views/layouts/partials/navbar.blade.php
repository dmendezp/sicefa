<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        @auth
            @if (checkRol('gdmf.academic_coordination'))
                <li class="nav-item d-none d-sm-inline-block mx-1">
                    <a href="{{ route('gdmf.academic_coordination.dashboard') }}" class="nav-link @if(Route::is('gdmf.academic_coordination.*')) active @endif">{{ trans('sigac::general.AcademicCoordination') }}</a>
                </li>
            @endif
            @if (checkRol('gdmf.instructor'))
                <li class="nav-item d-none d-sm-inline-block mx-1">
                    <a href="{{ route('gdmf.instructor.dashboard') }}" class="nav-link @if(Route::is('gdmf.instructor.*')) active @endif">{{ trans('sigac::general.Instructor') }}</a>
                </li>
            @endif
        @endauth
    </ul>
        ...
        <li class="nav-item dropdown mx-1">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0">
                <a href="{{ url('lang', ['en']) }}" class="dropdown-item">
                    <img src="{{ asset('modules/gdmf/images/flags/estados-unidos.webp') }}" alt="">
                    {{ trans('sigac::general.English') }}
                </a>
                <a href="{{ url('lang', ['es']) }}" class="dropdown-item">
                    <img src="{{ asset('modules/gdmf/images/flags/colombia.webp') }}" alt="">
