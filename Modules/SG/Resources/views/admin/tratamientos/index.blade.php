...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.admin.sg.tratamientos.create') }}"
            ...
            <table class="table table-hover table-bordered mb-0">
                ...
                @forelse($treatments as $treatment)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('sg.admin.sg.tratamientos.show', $treatment) }}"
                            ...
                            <form action="{{ route('sg.admin.sg.tratamientos.destroy', $treatment) }}"
                                  method="POST"
                                  class="d-inline">
                                @csrf @method('DELETE')
