        ...
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div class="text-right">
                    <a href="{{ route('sg.admin.sg.razas.index') }}" class="btn btn-secondary btn-sm">Volver</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('sg.admin.sg.razas.store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <a href="{{ route('sg.admin.sg.razas.index') }}" class="btn btn-link">Cancelar</a>
