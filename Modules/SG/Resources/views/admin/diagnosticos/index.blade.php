...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.admin.sg.diagnosticos.create') }}" class="btn btn-success">
            ...
            <table class="table table-hover table-bordered mb-0">
                ...
                @forelse($tests as $test)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('sg.admin.sg.diagnosticos.show', $test) }}"
                               class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-eye"></i>
                            </a>

                            <a href="{{ route('sg.admin.sg.diagnosticos.edit', $test) }}"
                               class="btn btn-sm btn-outline-warning">
                                <i class="fas fa-edit"></i>
                            </a>

                            <form action="{{ route('sg.admin.sg.diagnosticos.destroy', $test) }}"
