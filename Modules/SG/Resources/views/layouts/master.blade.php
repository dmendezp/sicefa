...
<head>
    ...
    <title>SG - Panel Administrativo</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item d-none d-sm-inline-block mr-3">
                    <a href="http://127.0.0.1:8000/sg/admin/welcome" class="btn btn-success btn-sm" title="Volver al panel admin">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <h6 class="dropdown-header">Cuenta Administrativo</h6>
                ...
                <nav class="mt-3">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sg.admin.sg.inseminaciones.create') }}" class="nav-link">
                                        <i class="fas fa-syringe nav-icon"></i>
                                        <p>Inseminaciones</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('sg.admin.sg.nacimientos.create') }}" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sg.admin.sg.tratamientos.create') }}" class="nav-link">
                                        <i class="fas fa-prescription-bottle-alt nav-icon"></i>
                                        <p>Tratamientos</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('sg.admin.sg.diagnosticos.create') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sg.admin.sg.pesos.create') }}" class="nav-link">
