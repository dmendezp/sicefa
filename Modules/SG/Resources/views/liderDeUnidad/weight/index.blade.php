...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.weight.create') }}"
                ...
                <tbody>
                    @forelse($records as $record)
                        <tr>
                            ...
                            {{-- ACCIONES --}}
                            <td class="text-center">
                                <a href="{{ route('sg.liderDeUnidad.sg.weight.show', $record) }}"
                                   class="btn btn-sm btn-outline-primary action-btn"
                                   data-toggle="tooltip" title="Ver">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('sg.liderDeUnidad.sg.weight.edit', $record) }}"
                                   class="btn btn-sm btn-outline-warning action-btn"
                                   data-toggle="tooltip" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('sg.liderDeUnidad.sg.weight.destroy', $record) }}"
