...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.animals.create') }}"
                    ...
                    <tbody>
                        ...
                        <tr class="row-hover">
                            ...
                            <td class="text-center">
                                <a href="{{ route('sg.liderDeUnidad.sg.animals.show', $animal) }}"
                                    class="btn btn-sm btn-outline-primary action-btn"
                                    data-toggle="tooltip" title="Ver">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('sg.liderDeUnidad.sg.animals.edit', $animal) }}"
                                    class="btn btn-sm btn-outline-warning action-btn"
                                    data-toggle="tooltip" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('sg.liderDeUnidad.sg.animals.destroy', $animal) }}"
