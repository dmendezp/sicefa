...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.breeds.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover table-bordered mb-0">
                ...
                @forelse($breeds as $breed)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('sg.liderDeUnidad.sg.breeds.show',$breed) }}"
                               class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-eye"></i>
                            </a>

                            <a href="{{ route('sg.liderDeUnidad.sg.breeds.edit',$breed) }}"
                               class="btn btn-sm btn-outline-warning">
                                <i class="fas fa-edit"></i>
                            </a>

                            <form action="{{ route('sg.liderDeUnidad.sg.breeds.destroy',$breed) }}"
                                  method="POST"
                                  class="d-inline">
                                @csrf @method('DELETE')
