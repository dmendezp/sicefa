...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.production.create') }}" class="btn btn-success btn-lg shadow-sm">
            ...
            <table class="table table-hover table-bordered mb-0">
                ...
                @forelse($productions as $prod)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('sg.liderDeUnidad.sg.production.show',$prod) }}" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('sg.liderDeUnidad.sg.production.edit',$prod) }}" class="btn btn-sm btn-outline-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{ route('sg.liderDeUnidad.sg.production.destroy',$prod) }}" class="d-inline">
                                @csrf @method('DELETE')
