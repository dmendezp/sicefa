...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.treatments.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left"></i> Volver
        </a>
    </div>

    <form action="{{ isset($treatment->id)
            ? route('sg.liderDeUnidad.sg.treatments.update', $treatment->id)
            : route('sg.liderDeUnidad.sg.treatments.store') }}"
          method="POST">
