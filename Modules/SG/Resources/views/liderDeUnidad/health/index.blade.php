...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.health.create') }}" class="btn btn-success">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm" role="group">
                                <a href="{{ route('sg.liderDeUnidad.sg.health.show', $record) }}"
                                   class="btn btn-outline-primary"
                                   title="Ver historia clínica">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('sg.liderDeUnidad.sg.health.edit', $record) }}"
                                   class="btn btn-outline-warning"
                                   title="Editar historia clínica">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <a href="{{ route('sg.liderDeUnidad.sg.treatments.index', ['health_record_id' => $record->id]) }}"
                                ...
                                <form method="POST"
                                      action="{{ route('sg.liderDeUnidad.sg.health.destroy', $record) }}"
                                      class="d-inline">
                                    @csrf @method('DELETE')
