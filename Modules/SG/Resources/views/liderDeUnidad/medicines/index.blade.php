...
<div class="container-fluid mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.medicines.create') }}"
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body d-flex flex-wrap align-items-center gap-2">
            ...
            <a href="{{ route('sg.liderDeUnidad.sg.medicines.index') }}"
               class="btn {{ !request('filter') ? 'btn-primary' : 'btn-outline-primary' }}">
                Todos
            </a>

            <a href="{{ route('sg.liderDeUnidad.sg.medicines.index',['filter'=>'low_stock']) }}"
            ...
            <a href="{{ route('sg.liderDeUnidad.sg.medicines.index',['filter'=>'near_expiration']) }}"
            ...
            <a href="{{ route('sg.liderDeUnidad.sg.medicines.index',['filter'=>'expired']) }}"
            ...
            <table class="table table-hover table-bordered mb-0">
                ...
                @forelse($medicines as $medicine)
                    ...
                    ">
                        ...
                        <td class="text-center">
                            <a href="{{ route('sg.liderDeUnidad.sg.medicines.show',$medicine) }}"
                               class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-eye"></i>
                            </a>

                            <a href="{{ route('sg.liderDeUnidad.sg.medicines.edit',$medicine) }}"
                               class="btn btn-sm btn-outline-warning">
                                <i class="fas fa-edit"></i>
                            </a>

                            <form action="{{ route('sg.liderDeUnidad.sg.medicines.destroy',$medicine) }}"
                                  method="POST"
                                  class="d-inline">
                                @csrf @method('DELETE')
