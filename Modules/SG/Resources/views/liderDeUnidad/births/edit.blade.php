...
<div class="container">
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            <form action="{{ route('sg.liderDeUnidad.sg.births.update', $birth->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                        ...
                        <select name="animal_id" class="form-control form-control-lg" required>
                            ...
                            @foreach($animals as $animal)
                                <option value="{{ $animal->id }}"
                                    {{ old('animal_id', $birth->animal_id) == $animal->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date"
                               name="birth_date"
                               value="{{ old('birth_date', $birth->birth_date->format('Y-m-d')) }}"
                        ...
                        <div class="d-flex mt-2">
                            <div class="custom-control custom-radio mr-4">
                                <input type="radio" id="male" name="calf_sex"
                                       ...
                                       {{ old('calf_sex', $birth->calf_sex) === 'MALE' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" id="female" name="calf_sex"
                                       value="FEMALE"
                                       class="custom-control-input"
                                       {{ old('calf_sex', $birth->calf_sex) === 'FEMALE' ? 'checked' : '' }}>
                        ...
                        <select name="calf_id" class="form-control form-control-lg">
                            ...
                            @foreach($newCalves as $calf)
                                <option value="{{ $calf->id }}"
                                    {{ old('calf_id', $birth->calf_id) == $calf->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('insemination_date', $birth->insemination_date?->format('Y-m-d')) }}"
                               class="form-control form-control-lg">
                    </div>
                        ...
                        <select name="bull_id" class="form-control form-control-lg">
                            ...
                            @foreach($bulls as $bull)
                                <option value="{{ $bull->id }}"
                                    {{ old('bull_id', $birth->bull_id) == $bull->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea name="observations"
                                  rows="4"
                                  class="form-control form-control-lg"
                                  placeholder="Complicaciones, estado de la madre, observaciones clínicas...">{{ old('observations', $birth->observations) }}</textarea>
                    </div>
