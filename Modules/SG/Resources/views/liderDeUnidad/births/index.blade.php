...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('sg.liderDeUnidad.sg.births.create') }}"
                    ...
                    <tbody>
                        @forelse($births as $birth)
                            <tr>
                                ...
                                {{-- ACCIONES --}}
                            <td class="text-center">
                                <a href="{{ route('sg.liderDeUnidad.sg.births.show', $birth) }}"
                                   class="btn btn-sm btn-outline-primary action-btn"
                                   data-toggle="tooltip" title="Ver">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('sg.liderDeUnidad.sg.births.edit', $birth) }}"
                                   class="btn btn-sm btn-outline-warning action-btn"
                                   data-toggle="tooltip" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('sg.liderDeUnidad.sg.births.destroy', $birth) }}"
                                      method="POST" class="d-inline"
                                      onsubmit="return confirm('¿Eliminar este parto?')">
                                    @csrf @method('DELETE')
