...
class InstructorResearcher extends Model
{
    use SoftDeletes, HasFactory;

    protected $table = 'instructor_researchers';
    ...
    /**
     * Sincronizando el rol por defecto 'sia.inst-inv' con el usuario asociado.
     */
    public function syncDefaultRole()
    {
        $role = \Modules\SICA\Entities\Role::where('slug', 'sia.inst-inv')->first();
        if ($role && $this->user) {
    ...
    /**
     * Eliminando lógicamente el registro y su relación con el usuario.
     */
    ...
    /**
     * Mostrando la información del instructor investigador.
     */
