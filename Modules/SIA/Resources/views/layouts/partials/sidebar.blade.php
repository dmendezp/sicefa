                ...
                <!-- Menú de opciones públicas -->
                    ...
                    @if (Route::is('sia.admin.*'))
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#"
                                class="nav-link {{ Route::is('sia.admin.human_talent.*') ? 'active' : '' }} text-light">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('sia.admin.human_talent.user') }}"
                                        class="nav-link {{ Route::is('sia.admin.human_talent.user') ? 'active' : '' }} text-light">
                                        <i class="nav-icon fa-solid fa-users"></i>
                                        <p>Usuarios</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('sia.admin.human_talent.apprentice') }}"
                                        class="nav-link {{ Route::is('sia.admin.human_talent.apprentice') ? 'active' : '' }} text-light">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.alliance.index') }}"
                                class="nav-link {{ Route::is('sia.admin.alliance.index') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-scale-balanced"></i>
                                <p>Gestion Alianzas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.event.index') }}"
                                class="nav-link {{ Route::is('sia.admin.event.index') ? 'active' : '' }} text-light">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.research_project.index') }}"
                                class="nav-link {{ Route::is('sia.admin.research_project.index') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-hands-holding-child"></i>
                                <p>Proyecto Investigacion</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.research_project.applications') }}"
                                class="nav-link {{ Route::is('sia.admin.research_project.applications') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-list-ul"></i>
                                <p>Gestion Postulaciones</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.research_project.group') }}"
                                class="nav-link {{ Route::is('sia.admin.research_project.group') ? 'active' : '' }} text-light">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('sia.admin.publication.index') }}"
                                class="nav-link {{ Route::is('sia.admin.publication.index') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-list-ul"></i>
                                <p>Gestion Publicaciones</p>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (Route::is('sia.instructor.*'))
                        <li class="nav-item">
                            <a href="{{ route('sia.instructor.research_project.group') }}"
                                class="nav-link {{ Route::is('sia.instructor.research_project.group') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-user-group"></i>
                                <p>Grupos de Investigacion</p>
                            </a>
                        </li>
                    ...
                    @if (Route::is('sia.apprentice.*'))
                        <li class="nav-item">
                            <a href="{{ route('sia.apprentice.research_project.apply') }}"
                                class="nav-link {{ Route::is('sia.apprentice.research_project.apply') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-list-ul"></i>
                                <p>Postulacion</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sia.apprentice.publication.create') }}"
                                class="nav-link {{ Route::is('sia.apprentice.publication.create') ? 'active' : '' }} text-light">
                                <i class="nav-icon fa-solid fa-list-ul"></i>
