<nav class="main-header navbar-background-cafeto navbar navbar-expand navbar-warning navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block mx-2">
            <a href="{{ route('cefa.sia.index') }}" class="nav-link text-light @if(Route::is('cefa.sia.*')) active @endif">{{ trans('sia::general.Home') }}</a>
        </li>
        @auth
    ...
    <ul class="navbar-nav ml-auto">
            ...
            <div type="button" class="button-login">
                @guest
                    <a href="{{ route('login', ['redirect' => url()->current()]) }}" class="text-decoration-none text-black"
                        <span>{{ trans('sia::general.Log In') }}</span>
                    </a>
                @else
        ...
        <li>
            <div class="nav-item dropdown mx-1">
                <button class="btn dropdown-toggle nav-link" type="button" data-bs-toggle="dropdown" aria-expanded="false"
                    ...
                    data-bs-title="{{ trans('sia::general.Language') }}">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a href="{{ url('lang', ['en']) }}" class="dropdown-item">
                            <img src="{{ asset('modules/sia/images/flags/estados-unidos.webp') }}" alt="Bandera de estados unidos" width="20px">
                            {{ trans('sia::general.English') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('lang', ['es']) }}" class="dropdown-item">
                            <img src="{{ asset('modules/sia/images/flags/colombia.webp') }}" alt="Bandera de colombia" width="20px">
        ...
        <li class="nav-item mx-1">
            <a class="nav-link" data-widget="fullscreen" href="#" role="button" data-bs-toggle="tooltip"
                data-bs-placement="bottom" data-bs-title="{{ trans('sia::general.Full Screen Mode') }}">
                <i class="fas fa-expand-arrows-alt"></i>
            </a>
        </li>
        <li class="nav-item mx-1">
            <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button"
                data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="{{ trans('sia::general.Apps') }}">
