                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ trans('cefamaps::environment.Type') }}
                                                {{ trans('cefamaps::environment.Environment') }}</th>
                                            <th>{{ trans('cefamaps::menu.Class') }}
                                                {{ trans('cefamaps::environment.Environment') }}</th>
                                                            ...
                                                            <div class="modal-content bg-info">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h1 class="modal-title" style="center">
                                                                        {{ trans('cefamaps::environment.Spot') }}
                                                                        {{ $env->name }}</h1>
                                                                ...
                                                                <div class="container text-center">
                                                                    <div class="row align-items-start">
                                                                        <div class="col">
                                                                            <div class="modal-header">
                                                                                <h3 class="modal-title">
                                                                                    {{ trans('cefamaps::environment.Length') }}
                                                                                </h3>
                                                                            </div>
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="modal-header">
                                                                                <h3 class="modal-title">
                                                                                    {{ trans('cefamaps::environment.Latitude') }}
                                                                                </h3>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <h5>{{ $env->latitude }}</h5>
                                                                ...
                                                                <h1 class="modal-title" style="center">
                                                                    {{ trans('cefamaps::environment.Polygon') }}
                                                                    {{ $env->name }}</h1>
        ...
        */
        $(document).ready(function() {
            $(document).on("click", ".delete-environment", function() {
                ...
                Swal.fire({
                    title: '{{ trans('cefamaps::menu.Are You Sure') }} {{ trans('cefamaps::menu.To') }} {{ trans('cefamaps::menu.Delete') }}' +
                        id,
