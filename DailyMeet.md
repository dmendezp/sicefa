...
---
#### Meet 02-Sep-2023
* **Integrante 1** - *Actividades realizadas*crear vistas generales para el rol de instructor - *Avance 10%* - *Dificultades* las vistas se desorganizaron- *Acciones*se migro se croe crud, contrlloler vistas  
* **Integrante 2** - *Actividades realizadas* - *Avance %* - *Dificultades* - *Acciones*
---
#### Meet 05-Sep-2023
* **Integrante 1** - *Actividades realizadas*se creo carpetas para los crud de glossaries y guidepost trabajando en las vistas delprimero- *Avance 10%* - *Dificultades*estableci mal las relaciones en la migracion en temas de llaves foraneas- *Acciones*borre toda vista y codigo hecho hasta el momento despues de un push para guardar cambios
#### Meet 06-Sep-2023
* **Integrante 1** - *Actividades realizadas*el cuadro de traductor cambie estilo y añadi funcion de javascript - *Avance 40%* - *Dificultades*el css se desorganizo todo - *Acciones* informarme de las apis grauitas de microsoft y google
---
## DICSENA 🛒

### Sprint 2 🔄
#### Sprint Planning 04-Sep-2023
...
#### Meet 09-Sep-2023
* **Integrante 1** - *Actividades realizadas*-borre los antiguos controller con la actualizacion de mis tablas aprobadas por pasantes e instructor *Avance 50%* - *Dificultades*digite mal agunos atributos y estos generarion error - *Acciones*
* **Integrante ** - *Actividades realizadas*realize solo commit para conservar vista y procesos erroneos- *Avance 30%* - *Dificultades*confundir la logica de post en el manjo de datos- *Acciones*ver videos tutoriale como loco
---
#### Meet 10-Sep-2023
* **Integrante 1** - *Actividades realizadas*estableci el models - *Avance 25%* - *Dificultades*ejecute mal las relaciones e hice com cinco rollback - *Acciones*
* **Integrante 1** - *Actividades realizadas* - *Avance %* - *Dificultades* - *Acciones*aplicar lo de internet y videos
---
#### Meet 11-Sep-2023
* **Integrante 1** - *Actividades realizadas*volver a integrar vista de glossaries cambiar de ubicacion la carpeta public trabaJar en guidepost para la subida de archivos - *Avance 40%* - *Dificultades*no tengo claro si usar libraria para el almacenamiento o aplicar una ruta destinada a guardar archivos - *Acciones*
* **Integrante 1** - *Actividades realizadas*organizar rutas - *Avance 20%* - *Dificultades*la correcta ubicacion de las vistas para ser mostradas - *Acciones*
---
#### Meet 02-Nov-2022
* **Integrante 1** - *Actividades realizadas* - *Avance %* - *Dificultades* - *Acciones*
* **Integrante 2** - *Actividades realizadas* - *Avance %* - *Dificultades* - *Acciones*
