<!-- Favicons -->
  <link href="{{ asset('general/images/logosicefa.png') }}" rel="icon">
  ...
  <link href="{{ asset('general/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
  <link href="{{ asset('general/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
  <link href="{{ asset('AdminLTE/plugins/fontawesome-free/css/all.css') }}" rel="stylesheet">
  <!-- Template Main CSS File -->
  <link href="{{ asset('general/assets/css/style.css') }}" rel="stylesheet">
  {{-- pantalla de carga --}}
  <link href="{{ asset('css/pantCarg.css') }}" rel="stylesheet">