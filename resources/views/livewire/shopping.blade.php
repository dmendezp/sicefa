                                        ...
                                        <div class="card-description">
                                            <p class="mt-1">
                                                ...
                                                <a style="margin-left: 10px" href="javascript:void(0);"
                                                    class="text-light float-right agregar-al-carrito"
                                                    data-name="{{ $e->name }}"
                                                    data-category="{{ $e->category->name }}"
                                                    data-price="{{ $e->price }}"
                                                    data-measurement="{{ $e->measurement_unit->name ?? 'N/A' }}"
                                                    data-kind="{{ $e->kind_of_purchase->name ?? 'N/A' }}"
                                                    data-unspsc="{{ $e->UNSPSC_code ?? 'N/A' }}">
                                                    <i class="fa-solid fa-shopping-cart fs-6"></i>
                                                </a>
                                            </p>
                                        </div>
                                    </div>
